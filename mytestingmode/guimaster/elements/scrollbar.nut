...
addEventHandler("GUI.onClick", GUI.ScrollBar.onClick.bindenv(GUI.ScrollBar))
addEventHandler("GUI.onMouseDown", GUI.ScrollBar.onMouseDown.bindenv(GUI.ScrollBar))
